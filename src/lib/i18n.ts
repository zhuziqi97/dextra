...
export const LANGUAGE_SETTINGS_STORAGE_KEY = "dextra.system_language_settings"
export const LANGUAGE_MODE_COOKIE_KEY = "dextra.language_mode"
export const LANGUAGE_COOKIE_KEY = "dextra.locale"
