 ...
 */
export const STORAGE_KEY_THEME_COLOR = "dextra-theme-color"
export const STORAGE_KEY_ZOOM_LEVEL = "dextra-zoom-level"

// 新会话欢迎页「模式选择区域」（代码开发 / 日常办公 快捷卡片）是否显示。
// 缺省即回退为开启（保持历史行为）；仅在欢迎态客户端渲染，无需预水合。
export const STORAGE_KEY_WELCOME_QUICK_ACTIONS = "dextra-welcome-quick-actions"
...
export const STORAGE_KEY_UI_FONT = "dextra-ui-font"
export const STORAGE_KEY_UI_FONT_CUSTOM = "dextra-ui-font-custom"
export const STORAGE_KEY_UI_FONT_STACK = "dextra-ui-font-stack"
export const STORAGE_KEY_EDITOR_FONT = "dextra-editor-font"
export const STORAGE_KEY_EDITOR_FONT_CUSTOM = "dextra-editor-font-custom"
export const STORAGE_KEY_EDITOR_FONT_SIZE = "dextra-editor-font-size"
export const STORAGE_KEY_EDITOR_LIGATURES = "dextra-editor-ligatures"
export const STORAGE_KEY_EDITOR_WORD_WRAP = "dextra-editor-word-wrap"
export const STORAGE_KEY_TERMINAL_FONT = "dextra-terminal-font"
export const STORAGE_KEY_TERMINAL_FONT_CUSTOM = "dextra-terminal-font-custom"
export const STORAGE_KEY_TERMINAL_FONT_SIZE = "dextra-terminal-font-size"
export const STORAGE_KEY_TERMINAL_LIGATURES = "dextra-terminal-ligatures"

// Workspace 背景图片。图片本身存磁盘（~/.dextra/backgrounds/），localStorage 只存
// 展示配置。仅 enabled 与 panel-opacity 需要预水合（它们作用于首帧就存在的结构性
// 表面）；mask/blur/fill 水合后才有意义（图片异步到达），不进 inline 脚本。
export const STORAGE_KEY_WORKSPACE_BG_ENABLED = "dextra-workspace-bg-enabled"
export const STORAGE_KEY_WORKSPACE_BG_MASK = "dextra-workspace-bg-mask"
export const STORAGE_KEY_WORKSPACE_BG_BLUR = "dextra-workspace-bg-blur"
export const STORAGE_KEY_WORKSPACE_BG_FILL = "dextra-workspace-bg-fill"
export const STORAGE_KEY_WORKSPACE_BG_PANEL_OPACITY =
  "dextra-workspace-bg-panel-opacity"
...
export const STORAGE_KEY_WORKSPACE_BG_IMAGE_VERSION =
  "dextra-workspace-bg-image-version"
...
export const STORAGE_KEY_WORKSPACE_BG_SOURCE_URL =
  "dextra-workspace-bg-source-url"
...
export const STORAGE_KEY_CUSTOM_THEME = "dextra-custom-theme"
export const STORAGE_KEY_CUSTOM_THEME_ENABLED = "dextra-custom-theme-enabled"
export const STORAGE_KEY_CUSTOM_CSS = "dextra-custom-css"
export const STORAGE_KEY_CUSTOM_CSS_ENABLED = "dextra-custom-css-enabled"
export const STORAGE_KEY_CUSTOM_STYLE_SUSPENDED =
  "dextra-custom-style-suspended"
...
(function() {
  try {
    ...
    // stack 只是「显式选择」的缓存，不是偏好本身：仅当存在显式 id（dextra-ui-font）
