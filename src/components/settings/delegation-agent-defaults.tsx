 ...
 *      chat-side `selectorsCache`. What the user sees here is what dextra-mcp
...
// collide with any real option id any agent could emit — the dextra
...
export function DelegationAgentDefaultsPanel({
  ...
  // Custom ACP agents are delegation targets too (dextra-mcp advertises them
