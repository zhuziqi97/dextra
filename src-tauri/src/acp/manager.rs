...
pub trait ScopedMcpServers: Send + Sync {
    async fn prepare(&self, parent_connection_id: &str) -> Result<Vec<agent_client_protocol::schema::v1::McpServer>, AcpError>;
}

#[derive(Clone)]
enum McpServerSource {
    Static(Vec<agent_client_protocol::schema::v1::McpServer>),
...
impl From<Vec<agent_client_protocol::schema::v1::McpServer>> for AdditionalMcpServers {
    fn from(servers: Vec<agent_client_protocol::schema::v1::McpServer>) -> Self {
